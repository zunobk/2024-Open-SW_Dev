...
class Model_load():
    ...
    def tracking_person(self, video_state, mask:np.ndarray, person_state, boundary_dilation=6):
        ...
        frame_files = sorted(
        [os.path.join(video_state["inpainting_images_path"], f) for f in os.listdir(video_state["inpainting_images_path"]) if f.endswith('.png') or f.endswith('.jpg')],
    ...
    def rev_tracking_person(self, video_state, mask: np.ndarray, person_state, boundary_dilation=6):
        ...
        frame_files = sorted(
            [os.path.join(video_state["inpainting_images_path"], f) for f in os.listdir(video_state["inpainting_images_path"])
